      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Trang chủ <em class="ion-ios-arrow-forward"></em></a></span> Thank You<span> <em class="ion-ios-arrow-forward"></em></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section ftco-no-pb">
    	<div class="container">
          ...
          <div class="col-md-6 text-center heading-section ftco-animate">
          	<h4 class="w3ls_head">Cảm ơn về cuộc hẹn của bạn. Số cuộc hẹn của bạn là <?php echo $_SESSION['aptno'];?> </h4>
        </div>
    	</div>
