      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Trang chủ <em class="ion-ios-arrow-forward"></em></a></span> <span>Về chúng tối <em class="ion-ios-arrow-forward"></em></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt">
            ...
            ?>
	          <div class="heading-section mb-4 mt-md-5">
	          	<h1 class="big">Về chúng tôi</h1>
	          	<span class="subheading"><?php  echo $row['Tieudetrang'];?></span>
	          </div>
	          <div class="pb-md-5">
