...
<html lang="en">
  <head>
    <title>SPA-Liên hệ chúng tôi</title>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Trang chủ <em class="ion-ios-arrow-forward"></em></a></span> <span>Liên hệ <em class="ion-ios-arrow-forward"></em></span></p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row no-gutters d-flex contact-info">
          ...
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="tel://0347689482">+ <?php  echo $row['Sodienthoai'];?></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="mailto:hangvuong1225@gmail.com"><?php  echo $row['Email'];?></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
