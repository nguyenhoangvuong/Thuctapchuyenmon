            ...
            <div class="main-page">
                <div class="tables">
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h3 style="font-family:times new roman;width:100%;text-align:center">Thêm thể loại</h3>
                            </div>
                            <div class="modal-body">
                                <div class="form-body">
									...
									echo $msg;
                                        ...
                                        <div class="form-group"> <label for="exampleInputPassword1">Tên thể loại</label>
                                            <input type="text" id="sername" name="sername" class="form-control"
                                                placeholder="Tên thể loại" value="" required="true"> </div>
                    ...
                    <div class="table-responsive bs-example widget-shadow">
                        <h4>Danh sách thể lọai <button id="myBtn" class="btn btn-primary">Thêm thể loại</button></h4>
							...
							while ($row=mysqli_fetch_array($ret)) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit-category.php?editid=<?php echo $row['Id'];?>">Sửa</a> || <a
                                            href="manage-category.php?id=<?php echo $row['Id']?>&del=delete"
