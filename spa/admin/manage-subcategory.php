                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h3 style="font-family:times new roman;width:100%;text-align:center">Thêm thể lọại phụ</h3>
                            </div>
                            <div class="modal-body">
                                <div class="form-body">
									...
									echo $msg;
                                        ...
                                        <div class="form-group"> <label for="exampleInputPassword1">Chọn thể
                                                loại</label>
                                            <div class="controls">
                                        ...
                                        <div class="form-group"> <label for="exampleInputPassword1">Tên thể loại
                                                phụ</label> <input type="text" id="sername" name="sername"
                                                class="form-control" placeholder="Tên thể loại phụ" value=""
                                                required="true"> </div>
							...
							while ($row=mysqli_fetch_array($ret)) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit-subcategory.php?editid=<?php echo $row['Id'];?>">Sửa</a> || <a
                                            href="manage-subcategory.php?id=<?php echo $row['Id']?>&del=delete"
