...
$timing=$_POST['timing'];
    ...
    $query=mysqli_query($con,"update tbltrang set Tieudetrang='$pagetitle',Email='$email',Sodienthoai='$mobnumber',Thoigian='$timing',Motatrang='$pagedes' where  Loaitrang='contactus'");
    if ($query) {
    $msg="Liên hệ với chúng tôi được cập nhật.";
  }
  else
    {
      $msg="Đã có lỗi xảy ra. Vui lòng nhập lại !";
    }
}
  ?>
<!DOCTYPE HTML>
...
<head>
    <title>SPA | Liên hệ với chúng tôi</title>
                    ...
                    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                        ...
                        <div class="form-body">
                            <form method="post">
                                ...
                                <div class="form-group"> <label for="exampleInputEmail1">Số điện thoại</label> <input
                                        type="text" class="form-control" name="mobnumber" id="mobnumber"
                                        value="<?php  echo $row['Sodienthoai'];?>" required="true"> </div>
                                <div class="form-group"> <label for="exampleInputEmail1">Thời gian</label> <input
                                        type="text" class="form-control" name="timing" id="timing"
                                        value="<?php  echo $row['Thoigian'];?>" required="true"> </div>
