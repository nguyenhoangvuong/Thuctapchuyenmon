...
<head>
    <title>SPA | Báo cáo giữa các ngày</title>
...
<body class="cbp-spmenu-push">
    <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="forms">
                    <h3 class="title1">Báo cáo giữa các ngày</h3>
                    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                        <div class="form-title">
                            <h4>Báo cáo giữa các ngày:</h4>
                        </div>
                        <div class="form-body">
                            <form method="post" name="bwdatesreport" action="bwdates-reports-details.php"
                                ...
                                <div class="form-group"> <label for="exampleInputEmail1">Từ ngày</label> <input
                                        ...
                                        required='true'> </div>
                                <div class="form-group"> <label for="exampleInputPassword1">Dến ngày</label><input
