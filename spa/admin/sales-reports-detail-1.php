            ...
            <div class="main-page">
                <div class="tables">
					...
					?>
						...
						$y2=date("Y",$month2);
					?>
                        <h4 class="header-title m-t-0 m-b-30">Bóa cáo bán hàng online theo tháng</h4>
                        <h4 align="center" style="color:blue">Báo cáo bán hàng từ ngày <?php echo $m1."-".$y1;?> đến
                            <?php echo $m2."-".$y2;?></h4>
                        <hr />
						...
						?>
                            <tr>
                                ...
                                <td><?php echo currency_format($total=$row['totalprice']);?>
                                </td>
                            </tr>
                            <?php
                            $ftotal+=$total;
					...
					$y2=date("Y",$year2);
				?>
                        <h4 class="header-title m-t-0 m-b-30">Báo cáo bán hàng online theo năm</h4>
                        <h4 align="center" style="color:blue">Báo cáo bán hàng từ <?php echo $y1;?> đến <?php echo $y2;?>
                        </h4>
                        <hr />
                        <table class="table table-bordered">
                            <thead>
