...
if (strlen($_SESSION['bpmsaid']==0)) {
    header('location:logout.php');
      ...
      if(isset($_POST['submit']))
      {
          ...
          $sql = mysqli_query($con,"update tblsanpham set Hinhanh2 = '$productimage2' where Id = '$pid'");
          if($sql){
...
<head>
    <title>Admin | Sửa hình ảnh 2</title>
...
<body class="cbp-spmenu-push">
    <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="forms">
                    <h3 class="title1">Cập nhật hình 2</h3></h3>
                    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                        <div class="form-body">
                            <form class="form-horizontal row-fluid" name="insertproduct" method="post"
                                ...
                                ?> </p>
                                <?php $query = mysqli_query($con,"select Tensanpham,Hinhanh2 from tblsanpham where Id='$pid'");
                                        $cnt = 1;
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="productimages/<?php echo $pid ?>/<?php echo $row['Hinhanh2'] ?>" width="200" height="200">
                                </div>
