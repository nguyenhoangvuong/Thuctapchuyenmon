...
<head>
    <title>SPA || Tìm kiếm cuộc hẹn</title>
                    ...
                    <div class="table-responsive bs-example widget-shadow">
                        ...
                        <div class="form-body">
                            <form method="post" name="search" action="">
                                ...
                                <div class="form-group"> <label for="exampleInputEmail1">Tìm kiếm bởi số cuộc
                                        hẹn</label> <input id="searchdata" type="text" name="searchdata" required="true"
                                        class="form-control">
                                    <br>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
									$ret=mysqli_query($con,"select *from  tblcuochen where Socuochen like '%$sdata%' || Ten like '%$sdata%' || Sodienthoai like '%$sdata%'");
