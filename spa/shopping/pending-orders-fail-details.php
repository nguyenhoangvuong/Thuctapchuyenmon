                        ...
                        <div class="table-responsive">
                            <form name="cart" method="post">
                                ...
                                <table class="table" style="border:0px">
                                    ...
                                    <tbody>
                                        <?php $query=mysqli_query($con,"select tblsanpham.Hinhanh1 as pimg1,tblsanpham.Tensanpham as pname,tblsanpham.Id as proid,tblctod.SanphamId as opid,sum(tblctod.Soluong) as qty,sum(tblsanpham.Giasanpham) as pprice,tblsanpham.Phivanchuyen as shippingcharge,tblorders.Id as orderid from tblctod join tblsanpham on tblctod.SanphamId=tblsanpham.Id join tblorders on tblctod.OrderId = tblorders.Id where tblorders.UserId='".$_SESSION['id']."' and tblorders.Phuongthucthanhtoan is null group by tblsanpham.Tensanpham");
											$cnt=1;
