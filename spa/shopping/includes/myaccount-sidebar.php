	            ...
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                    <ul class="nav nav-checkout-progress list-unstyled">
	                        ...
	                        <li><a href="bill-ship-addresses.php"> Địa chỉ thanh toán</a></li>
	                        <li><a href="order-history.php">Lịch sử đơn hàng</a></li>
	                        <li><a href="pending-orders.php">Đơn hàng đang chờ duyệt</a></li>
							<li><a href="pending-orders-fail.php">Đơn hàng chưa thanh toán</a></li>
	                    </ul>
	                </div>
	            </div>
	        </div>
