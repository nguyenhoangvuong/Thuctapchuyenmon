...
CREATE TABLE `tbltheloai` (
  ...
  `Motatheloai` longtext,
  `Ngaytao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Ngaycapnhap` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbltheloai` (`Id`, `Tentheloai`, `Motatheloai`, `Ngaytao`, `Ngaycapnhap`) VALUES
...
INSERT INTO `tblorders` (`Id`, `UserId`, `sanphamId`, `Soluong`, `Ngayorder`, `Phuongthucthanhtoan`, `Tinhtrangorder`) VALUES
...
CREATE TABLE `tbldanhgiasanpham` (
  ...
  `Tomluoc` varchar(255) DEFAULT NULL,
  `Review` longtext,
...
CREATE TABLE `tblsanpham` (
  ...
  `Sanphamcosan` varchar(255) DEFAULT NULL,
...
CREATE TABLE `tbltheloaiphu` (
  ...
  `theloaiphu` varchar(255) DEFAULT NULL,
...
CREATE TABLE `tblnhatkynguoidung` (
  ...
  `Thoitgianlogin` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
--
INSERT INTO `tblnhatkynguoidung` (`Id`, `Emailnguoidung`, `Ipnguoidung`, `Thoitgianlogin`, `Thoigianlogout`, `Trangthai`) VALUES
...
CREATE TABLE `tblusers` (
  ...
  `Diachigiaohang` longtext,
  `Trangthaivanchuyen` varchar(255) DEFAULT NULL,
  `Thanhphovanchuyen` varchar(255) DEFAULT NULL,
  `Mapinvanchuyen` int(11) DEFAULT NULL,
  `Diachithanhtoan` longtext,
  `Trangthaithanhtoan` varchar(255) DEFAULT NULL,
  `Thanhphothanhtoan` varchar(255) DEFAULT NULL,
  `Mapinthanhtoan` int(11) DEFAULT NULL,
...
INSERT INTO `tblusers` (`Id`, `Ten`, `Email`, `Lienhe`, `Matkhau`, `Diachigiaohang`, `Trangthaivanchuyen`, `Thanhphovanchuyen`, `Mapinvanchuyen`, `Diachithanhtoan`, `Trangthaithanhtoan`, `Thanhphothanhtoan`, `Mapinthanhtoan`, `Ngaydangky`, `Ngaycapnhat`) VALUES
